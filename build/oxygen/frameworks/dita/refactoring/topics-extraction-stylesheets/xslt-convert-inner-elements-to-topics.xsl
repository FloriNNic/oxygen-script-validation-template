...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="@href[starts-with(., '#')]" mode="write-sect #default">
     ...
     <xd:doc>
        <xd:desc> Update the conref attributes for cross references.</xd:desc>
    </xd:doc>
    <xsl:template match="@conref[starts-with(., '#')]" mode="write-sect #default">
    ...
    <xd:doc>
        <xd:desc> Update the conrefend attributes for cross references.</xd:desc>
    </xd:doc>
    <xsl:template match="@conrefend[starts-with(., '#')]" mode="write-sect #default">
        <xsl:attribute name="conrefend">
            <xsl:value-of select="f:updateHrefValue(., /, base-uri())"/>
        </xsl:attribute>
    </xsl:template>
