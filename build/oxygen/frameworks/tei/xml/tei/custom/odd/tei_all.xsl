...
<xsl:stylesheet xmlns:dcr="http://www.isocat.org/ns/dcr"
   ...
   <!--PATTERN schematron-constraint-tei_all-att.global.source-source-only_1_ODD_source-5-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-att.measurement-att-measurement-unitRef-6-->
   <!--RULE -->
   <xsl:template match="tei:*[@unitRef]" priority="1000" mode="M14">
   ...
   <!--PATTERN schematron-constraint-tei_all-att.typed-subtypeTyped-7-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-att.pointing-targetLang-targetLang-8-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-att.spanning-spanTo-spanTo-points-to-following-9-->
   <!--RULE -->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_all-att.styleDef-schemeVersion-schemeVersionRequiresScheme-10-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-ptr-ptrAtts-17-->
   <!--RULE -->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_all-ref-refAtts-18-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-list-gloss-list-must-have-labels-19-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-relatedItem-targetorcontent1-20-->
   <!--RULE -->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_all-l-abstractModel-structure-l-in-l-21-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-lg-atleast1oflggapl-22-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-lg-abstractModel-structure-lg-in-l-23-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-quotation-quotationContents-24-->
   <!--RULE -->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_all-citeStructure-delim-citestructure-inner-delim-25-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-citeStructure-match-citestructure-outer-match-26-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-citeStructure-match-citestructure-inner-match-27-->
   <!--RULE -->
   <xsl:template match="tei:citeStructure[parent::tei:citeStructure]"
                 priority="1000"
                 mode="M35">
   ...
   <!--PATTERN schematron-constraint-tei_all-div-abstractModel-structure-div-in-l-or-lg-30-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-div-abstractModel-structure-div-in-ab-or-p-31-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-shift-shiftNew-32-->
   <!--RULE -->
   <xsl:template match="tei:shift" priority="1000" mode="M38">
...
remarkable at this point. (@new / warning)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_all-s-noNestedS-33-->
   <!--RULE -->
   <xsl:template match="tei:s" priority="1000" mode="M39">
   ...
   <!--PATTERN schematron-constraint-tei_all-span-targetfrom-34-->
   <!--RULE -->
...
Only one of the attributes @target and @from may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_all-span-targetto-35-->
   <!--RULE -->
...
Only one of the attributes @target and @to may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_all-span-tonotfrom-36-->
   <!--RULE -->
...
If @to is supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_all-span-tofrom-37-->
   <!--RULE -->
   <xsl:template match="tei:span" priority="1000" mode="M43">
...
The attributes @to and @from on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_all-catchwords-catchword_in_msDesc-38-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-dimensions-duplicateDim-39-->
   <!--RULE -->
...
The element <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_all-secFol-secFol_in_msDesc-40-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-signatures-signatures_in_msDesc-41-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-msIdentifier-msId_minimal-42-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-path-pathmustnotbeclosed-43-->
   <!--RULE -->
   <xsl:template match="tei:path[@points]" priority="1000" mode="M49">
   ...
   <!--PATTERN schematron-constraint-tei_all-addSpan-addSpan-requires-spanTo-44-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-damageSpan-damageSpan-requires-spanTo-46-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-delSpan-delSpan-requires-spanTo-48-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-subst-substContents1-50-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-rdgGrp-only1lem-51-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-variantEncoding-location-variantEncodingLocation-52-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-relation-reforkeyorname-53-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-relation-activemutual-54-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-relation-activepassive-55-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-ab-abstractModel-structure-ab-in-ab-or-p-57-->
   <!--RULE -->
   <xsl:template match="tei:ab" priority="1000" mode="M60">

		<!--REPORT -->
      <xsl:if test="    (ancestor::tei:p or ancestor::tei:ab)                          and not( ancestor::tei:floatingText                                  |parent::tei:exemplum                                 |parent::tei:item                                 |parent::tei:note                                 |parent::tei:q                                 |parent::tei:quote                                 |parent::tei:remarks                                 |parent::tei:said                                 |parent::tei:sp                                 |parent::tei:stage                                 |parent::tei:cell                                 |parent::tei:figure                                )">
         <xsl:message>
        Abstract model violation: ab may not occur inside paragraphs or other ab elements.
       ((ancestor::tei:p or ancestor::tei:ab) and not( ancestor::tei:floatingText |parent::tei:exemplum |parent::tei:item |parent::tei:note |parent::tei:q |parent::tei:quote |parent::tei:remarks |parent::tei:said |parent::tei:sp |parent::tei:stage |parent::tei:cell |parent::tei:figure ))</xsl:message>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M60"/>
   </xsl:template>
   ...
   <!--PATTERN schematron-constraint-tei_all-ab-abstractModel-structure-ab-in-l-or-lg-58-->
   <!--RULE -->
...
Child elements of <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_all-moduleRef-prefix-not-except-and-include-67-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-listRef-TagDocsNestinglistRef-69-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-listRef-TagDocslistRefChildren-70-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-altIdent-deprecate_altIdent_in_non-ODD_places-71-->
   <!--RULE -->
   <xsl:template match="tei:altIdent" priority="1000" mode="M74">
   ...
   <!--PATTERN schematron-constraint-tei_all-altIdent-altIdent_usually_an_NCName-72-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-model-no_dup_default_models-73-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-model-no_dup_models-74-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-modelSequence-no_outputs_nor_predicates_4_my_kids-75-->
   <!--RULE -->
   <xsl:template match="tei:modelSequence" priority="1000" mode="M78">
   ...
   <!--PATTERN schematron-constraint-tei_all-sequence-sequencechilden-76-->
   <!--RULE -->
   <xsl:template match="tei:sequence" priority="1000" mode="M79">
   ...
   <!--PATTERN schematron-constraint-tei_all-alternate-alternatechilden-77-->
   <!--RULE -->
   <xsl:template match="tei:alternate" priority="1000" mode="M80">
   ...
   <!--PATTERN schematron-constraint-tei_all-constraintSpec-empty-based-on-mode-78-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-constraintSpec-sch_no_more-79-->
   <!--RULE -->
   <xsl:template match="tei:constraintSpec" priority="1000" mode="M82">
   ...
   <!--PATTERN schematron-constraint-tei_all-constraintSpec-isosch-80-->
   <!--RULE -->
   <xsl:template match="tei:constraintSpec" priority="1000" mode="M83">
   ...
   <!--PATTERN schematron-constraint-tei_all-constraintSpec-needrules-81-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-constraintSpec-unique-constraintSpec-ident-82-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-attDef-attDefContents-83-->
   <!--RULE -->
   <xsl:template match="tei:attDef" priority="1000" mode="M86">
   ...
   <!--PATTERN schematron-constraint-tei_all-attDef-noDefault4Required-84-->
   <!--RULE -->
   <xsl:template match="tei:attDef[@usage eq 'req']" priority="1000" mode="M87">
   ...
   <!--PATTERN schematron-constraint-tei_all-attDef-defaultIsInClosedList-twoOrMore-85-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-attDef-defaultIsInClosedList-one-86-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-dataRef-restrictDataFacet-87-->
   <!--RULE -->
   <xsl:template match="tei:dataRef[tei:dataFacet]" priority="1000" mode="M90">
   ...
   <!--PATTERN schematron-constraint-tei_all-dataRef-restrictAttRestriction-88-->
   <!--RULE -->
   <xsl:template match="tei:dataRef[tei:dataFacet]" priority="1000" mode="M91">
   ...
   <!--PATTERN schematron-constraint-tei_all-dataRef-restrictAttResctrictionName-89-->
   <!--RULE -->
   <xsl:template match="tei:dataRef" priority="1000" mode="M92">
