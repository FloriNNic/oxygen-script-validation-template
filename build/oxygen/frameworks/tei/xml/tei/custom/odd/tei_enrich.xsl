...
<xsl:stylesheet xmlns:dcr="http://www.isocat.org/ns/dcr"
   ...
   <!--PATTERN schematron-constraint-tei_enrich-att.global.source-source-only_1_ODD_source-5-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-att.measurement-att-measurement-unitRef-6-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-att.typed-subtypeTyped-7-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-att.pointing-targetLang-targetLang-8-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-att.spanning-spanTo-spanTo-points-to-following-9-->
   <!--RULE -->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_enrich-att.styleDef-schemeVersion-schemeVersionRequiresScheme-10-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-date-dates-17-->
   <!--RULE -->
   <xsl:template match="tei:date" priority="1000" mode="M21">
   ...
   <!--PATTERN schematron-constraint-tei_enrich-ptr-ptrAtts-18-->
   <!--RULE -->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_enrich-ref-refAtts-19-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-list-gloss-list-must-have-labels-20-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-relatedItem-targetorcontent1-21-->
   <!--RULE -->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_enrich-l-abstractModel-structure-l-in-l-22-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-lg-atleast1oflggapl-23-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-lg-abstractModel-structure-lg-in-l-24-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-citeStructure-delim-citestructure-inner-delim-25-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-citeStructure-match-citestructure-outer-match-26-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-citeStructure-match-citestructure-inner-match-27-->
   <!--RULE -->
   <xsl:template match="tei:citeStructure[parent::tei:citeStructure]"
                 priority="1000"
                 mode="M31">
   ...
   <!--PATTERN schematron-constraint-tei_enrich-div-abstractModel-structure-div-in-l-or-lg-30-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-div-abstractModel-structure-div-in-ab-or-p-31-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-catchwords-catchword_in_msDesc-32-->
   <!--RULE -->
   <xsl:template match="tei:catchwords" priority="1000" mode="M34">
   ...
   <!--PATTERN schematron-constraint-tei_enrich-dimensions-duplicateDim-33-->
   <!--RULE -->
   <xsl:template match="tei:dimensions" priority="1000" mode="M35">
...
The element <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_enrich-secFol-secFol_in_msDesc-34-->
   <!--RULE -->
   <xsl:template match="tei:secFol" priority="1000" mode="M36">
   ...
   <!--PATTERN schematron-constraint-tei_enrich-signatures-signatures_in_msDesc-35-->
   <!--RULE -->
   <xsl:template match="tei:signatures" priority="1000" mode="M37">
   ...
   <!--PATTERN schematron-constraint-tei_enrich-msIdentifier-msId_minimal-36-->
   <!--RULE -->
   <xsl:template match="tei:msIdentifier" priority="1000" mode="M38">
   ...
   <!--PATTERN schematron-constraint-tei_enrich-standOff-nested_standOff_should_be_typed-37-->
   <!--RULE -->
   <xsl:template match="tei:standOff" priority="1000" mode="M39">
   ...
   <!--PATTERN schematron-constraint-tei_enrich-relation-reforkeyorname-38-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-relation-activemutual-39-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-relation-activepassive-40-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-addSpan-addSpan-requires-spanTo-42-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-damageSpan-damageSpan-requires-spanTo-44-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-delSpan-delSpan-requires-spanTo-46-->
   <!--RULE -->
