...
<xsl:stylesheet xmlns:dcr="http://www.isocat.org/ns/dcr"
   ...
   <!--PATTERN schematron-constraint-tei_speech-att.global.source-source-only_1_ODD_source-5-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-att.measurement-att-measurement-unitRef-6-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-att.typed-subtypeTyped-7-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-att.pointing-targetLang-targetLang-8-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-att.spanning-spanTo-spanTo-points-to-following-9-->
   <!--RULE -->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_speech-att.styleDef-schemeVersion-schemeVersionRequiresScheme-10-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-ptr-ptrAtts-17-->
   <!--RULE -->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_speech-ref-refAtts-18-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-list-gloss-list-must-have-labels-19-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-relatedItem-targetorcontent1-20-->
   <!--RULE -->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_speech-l-abstractModel-structure-l-in-l-21-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-lg-atleast1oflggapl-22-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-lg-abstractModel-structure-lg-in-l-23-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-quotation-quotationContents-24-->
   <!--RULE -->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_speech-citeStructure-delim-citestructure-inner-delim-25-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-citeStructure-match-citestructure-outer-match-26-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-citeStructure-match-citestructure-inner-match-27-->
   <!--RULE -->
   <xsl:template match="tei:citeStructure[parent::tei:citeStructure]"
                 priority="1000"
                 mode="M31">
   ...
   <!--PATTERN schematron-constraint-tei_speech-div-abstractModel-structure-div-in-l-or-lg-30-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-div-abstractModel-structure-div-in-ab-or-p-31-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-shift-shiftNew-32-->
   <!--RULE -->
...
remarkable at this point. (@new / warning)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_speech-relation-reforkeyorname-33-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-relation-activemutual-34-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-relation-activepassive-35-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-ab-abstractModel-structure-ab-in-ab-or-p-37-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-ab-abstractModel-structure-ab-in-l-or-lg-38-->
   <!--RULE -->
