...
<xsl:stylesheet xmlns:iso="http://purl.oclc.org/dsdl/schematron"
   ...
   <!--PATTERN schematron-constraint-tei_bare-p-abstractModel-structure-p-in-ab-or-p-6-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_bare-p-abstractModel-structure-p-in-l-or-lg-7-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_bare-div-abstractModel-structure-div-in-l-or-lg-11-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_bare-div-abstractModel-structure-div-in-ab-or-p-12-->
   <!--RULE -->
