...
<xsl:stylesheet xmlns:dcr="http://www.isocat.org/ns/dcr"
   ...
   <!--PATTERN schematron-constraint-tei_basic-att.global.source-source-only_1_ODD_source-5-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_basic-att.measurement-att-measurement-unitRef-6-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_basic-att.typed-subtypeTyped-7-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_basic-att.pointing-targetLang-targetLang-8-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_basic-att.spanning-spanTo-spanTo-points-to-following-9-->
   <!--RULE -->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_basic-att.styleDef-schemeVersion-schemeVersionRequiresScheme-10-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_basic-ptr-ptrAtts-17-->
   <!--RULE -->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_basic-ref-refAtts-18-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_basic-list-gloss-list-must-have-labels-19-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_basic-relatedItem-targetorcontent1-20-->
   <!--RULE -->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_basic-l-abstractModel-structure-l-in-l-21-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_basic-lg-atleast1oflggapl-22-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_basic-lg-abstractModel-structure-lg-in-l-23-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_basic-quotation-quotationContents-24-->
   <!--RULE -->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_basic-citeStructure-delim-citestructure-inner-delim-25-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_basic-citeStructure-match-citestructure-outer-match-26-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_basic-citeStructure-match-citestructure-inner-match-27-->
   <!--RULE -->
   <xsl:template match="tei:citeStructure[parent::tei:citeStructure]"
                 priority="1000"
                 mode="M31">
   ...
   <!--PATTERN schematron-constraint-tei_basic-div-abstractModel-structure-div-in-l-or-lg-30-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_basic-div-abstractModel-structure-div-in-ab-or-p-31-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_basic-shift-shiftNew-32-->
   <!--RULE -->
   <xsl:template match="tei:shift" priority="1000" mode="M34">
...
remarkable at this point. (@new / warning)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_basic-s-noNestedS-33-->
   <!--RULE -->
   <xsl:template match="tei:s" priority="1000" mode="M35">
   ...
   <!--PATTERN schematron-constraint-tei_basic-span-targetfrom-34-->
   <!--RULE -->
...
Only one of the attributes @target and @from may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_basic-span-targetto-35-->
   <!--RULE -->
...
Only one of the attributes @target and @to may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_basic-span-tonotfrom-36-->
   <!--RULE -->
...
If @to is supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_basic-span-tofrom-37-->
   <!--RULE -->
...
The attributes @to and @from on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_basic-catchwords-catchword_in_msDesc-38-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_basic-dimensions-duplicateDim-39-->
   <!--RULE -->
...
The element <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_basic-secFol-secFol_in_msDesc-40-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_basic-signatures-signatures_in_msDesc-41-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_basic-msIdentifier-msId_minimal-42-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_basic-path-pathmustnotbeclosed-43-->
   <!--RULE -->
   <xsl:template match="tei:path[@points]" priority="1000" mode="M45">
   ...
   <!--PATTERN schematron-constraint-tei_basic-addSpan-addSpan-requires-spanTo-44-->
   <!--RULE -->
   <xsl:template match="tei:addSpan" priority="1000" mode="M46">
   ...
   <!--PATTERN schematron-constraint-tei_basic-damageSpan-damageSpan-requires-spanTo-46-->
   <!--RULE -->
   <xsl:template match="tei:damageSpan" priority="1000" mode="M47">
   ...
   <!--PATTERN schematron-constraint-tei_basic-delSpan-delSpan-requires-spanTo-48-->
   <!--RULE -->
   <xsl:template match="tei:delSpan" priority="1000" mode="M48">
   ...
   <!--PATTERN schematron-constraint-tei_basic-subst-substContents1-50-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_basic-rdgGrp-only1lem-51-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_basic-variantEncoding-location-variantEncodingLocation-52-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_basic-relation-reforkeyorname-53-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_basic-relation-activemutual-54-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_basic-relation-activepassive-55-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_basic-ab-abstractModel-structure-ab-in-ab-or-p-57-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_basic-ab-abstractModel-structure-ab-in-l-or-lg-58-->
   <!--RULE -->
