...
<xsl:stylesheet xmlns:iso="http://purl.oclc.org/dsdl/schematron"
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-att.global.source-source-only_1_ODD_source-7-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-att.measurement-att-measurement-unitRef-8-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-att.typed-subtypeTyped-9-->
   <!--RULE -->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-ab-abstractModel-structure-ab-in-ab-or-p-14-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-ab-abstractModel-structure-ab-in-l-or-lg-15-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-bibl-noEmptyBibl-16-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-choice-choiceSize-17-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-choice-choiceContent-18-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-desc-deprecationInfo-only-in-deprecated-19-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-div-abstractModel-structure-div-in-l-or-lg-20-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-div-abstractModel-structure-div-in-ab-or-p-21-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-l-abstractModel-structure-l-in-l-22-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-lg-atleast1oflggapl-23-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-lg-abstractModel-structure-lg-in-l-24-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-list-gloss-list-must-have-labels-25-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-p-abstractModel-structure-p-in-ab-or-p-26-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-p-abstractModel-structure-p-in-l-or-lg-27-->
   <!--RULE -->
