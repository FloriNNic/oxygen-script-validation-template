...
<xsl:stylesheet xmlns:dcr="http://www.isocat.org/ns/dcr"
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-att.global.source-source-only_1_ODD_source-5-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-att.measurement-att-measurement-unitRef-6-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-att.typed-subtypeTyped-7-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-att.pointing-targetLang-targetLang-8-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-att.spanning-spanTo-spanTo-points-to-following-9-->
   <!--RULE -->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-att.styleDef-schemeVersion-schemeVersionRequiresScheme-10-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-ptr-ptrAtts-17-->
   <!--RULE -->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-ref-refAtts-18-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-list-gloss-list-must-have-labels-19-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-relatedItem-targetorcontent1-20-->
   <!--RULE -->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-l-abstractModel-structure-l-in-l-21-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-lg-atleast1oflggapl-22-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-lg-abstractModel-structure-lg-in-l-23-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-quotation-quotationContents-24-->
   <!--RULE -->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-citeStructure-delim-citestructure-inner-delim-25-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-citeStructure-match-citestructure-outer-match-26-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-citeStructure-match-citestructure-inner-match-27-->
   <!--RULE -->
   <xsl:template match="tei:citeStructure[parent::tei:citeStructure]"
                 priority="1000"
                 mode="M35">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-div-abstractModel-structure-div-in-l-or-lg-30-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-div-abstractModel-structure-div-in-ab-or-p-31-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-shift-shiftNew-32-->
   <!--RULE -->
...
remarkable at this point. (@new / warning)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-catchwords-catchword_in_msDesc-33-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-dimensions-duplicateDim-34-->
   <!--RULE -->
...
The element <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-secFol-secFol_in_msDesc-35-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-signatures-signatures_in_msDesc-36-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-msIdentifier-msId_minimal-37-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-path-pathmustnotbeclosed-38-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-addSpan-addSpan-requires-spanTo-39-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-damageSpan-damageSpan-requires-spanTo-41-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-delSpan-delSpan-requires-spanTo-43-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-subst-substContents1-45-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-rdgGrp-only1lem-46-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-variantEncoding-location-variantEncodingLocation-47-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-relation-reforkeyorname-48-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-relation-activemutual-49-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-relation-activepassive-50-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-ab-abstractModel-structure-ab-in-ab-or-p-52-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-ab-abstractModel-structure-ab-in-l-or-lg-53-->
   <!--RULE -->
...
Child elements of <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-moduleRef-prefix-not-except-and-include-67-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-listRef-TagDocsNestinglistRef-69-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-listRef-TagDocslistRefChildren-70-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-altIdent-deprecate_altIdent_in_non-ODD_places-71-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-altIdent-altIdent_usually_an_NCName-72-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-model-no_dup_default_models-73-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-model-no_dup_models-74-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-modelSequence-no_outputs_nor_predicates_4_my_kids-75-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-sequence-sequencechilden-76-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-alternate-alternatechilden-77-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-constraintSpec-empty-based-on-mode-78-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-constraintSpec-sch_no_more-79-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-constraintSpec-isosch-80-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-constraintSpec-needrules-81-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-constraintSpec-unique-constraintSpec-ident-82-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-attDef-attDefContents-83-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-attDef-noDefault4Required-84-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-attDef-defaultIsInClosedList-twoOrMore-85-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-attDef-defaultIsInClosedList-one-86-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-dataRef-restrictDataFacet-87-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-dataRef-restrictAttRestriction-88-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-dataRef-restrictAttResctrictionName-89-->
   <!--RULE -->
