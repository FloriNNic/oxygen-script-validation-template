...
<xsl:stylesheet xmlns:dcr="http://www.isocat.org/ns/dcr"
   ...
   <!--PATTERN schematron-constraint-tei_svg-att.global.source-source-only_1_ODD_source-5-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-att.measurement-att-measurement-unitRef-6-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-att.typed-subtypeTyped-7-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-att.pointing-targetLang-targetLang-8-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-att.spanning-spanTo-spanTo-points-to-following-9-->
   <!--RULE -->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_svg-att.styleDef-schemeVersion-schemeVersionRequiresScheme-10-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-ptr-ptrAtts-17-->
   <!--RULE -->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_svg-ref-refAtts-18-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-list-gloss-list-must-have-labels-19-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-relatedItem-targetorcontent1-20-->
   <!--RULE -->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_svg-l-abstractModel-structure-l-in-l-21-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-lg-atleast1oflggapl-22-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-lg-abstractModel-structure-lg-in-l-23-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-quotation-quotationContents-24-->
   <!--RULE -->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_svg-citeStructure-delim-citestructure-inner-delim-25-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-citeStructure-match-citestructure-outer-match-26-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-citeStructure-match-citestructure-inner-match-27-->
   <!--RULE -->
   <xsl:template match="tei:citeStructure[parent::tei:citeStructure]"
                 priority="1000"
                 mode="M31">
   ...
   <!--PATTERN schematron-constraint-tei_svg-div-abstractModel-structure-div-in-l-or-lg-30-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-div-abstractModel-structure-div-in-ab-or-p-31-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-link-linkTargets3-32-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-ab-abstractModel-structure-ab-in-ab-or-p-33-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-ab-abstractModel-structure-ab-in-l-or-lg-34-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-join-joinTargets3-35-->
   <!--RULE -->
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_svg-standOff-nested_standOff_should_be_typed-36-->
   <!--RULE -->
