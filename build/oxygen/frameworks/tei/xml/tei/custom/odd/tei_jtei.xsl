...
<xsl:stylesheet xmlns:eg="http://www.tei-c.org/ns/Examples"
   ...
   <!--PATTERN schematron-constraint-tei_jtei-p-abstractModel-structure-p-in-ab-or-p-6-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-p-abstractModel-structure-p-in-l-or-lg-7-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-quote-jtei.sch-core-8-->
   <!--RULE -->
   <xsl:template match="tei:quote" priority="1000" mode="M17">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-cit-jtei.sch-cit-9-->
   <!--RULE -->
   <xsl:template match="tei:cit" priority="1000" mode="M18">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-desc-deprecationInfo-only-in-deprecated-10-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-gap-jtei.sch-gap-11-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-gap-jtei.sch-gap-ws-12-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-ptr-jtei.sch-ptr-multipleTargets-13-->
   <!--RULE -->
   <xsl:template match="tei:ptr[not(@type='crossref')]" priority="1000" mode="M22">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-ptr-ptrAtts-14-->
   <!--RULE -->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_jtei-ref-jtei.sch-ref-multipleTargets-15-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-ref-jtei.sch-biblref-parentheses-16-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-ref-jtei.sch-biblref-target-17-->
   <!--RULE -->
   <xsl:template match="tei:ref[@type eq 'bibl']" priority="1000" mode="M26">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-ref-jtei.sch-biblref-type-18-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-ref-refAtts-19-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-list-gloss-list-must-have-labels-20-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-head-jtei.sch-head-number-21-->
   <!--RULE -->
   <xsl:template match="tei:head" priority="1000" mode="M30">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-head-jtei.sch-figure-head-22-->
   <!--RULE -->
   <xsl:template match="tei:figure/tei:head" priority="1000" mode="M31">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-note-jtei.sch-note-punctuation-23-->
   <!--RULE -->
   <xsl:template match="tei:note" priority="1003" mode="M32">
   ...
   <!--RULE -->
   <xsl:template match="tei:note" priority="1002" mode="M32">
   ...
   <!--RULE -->
   <xsl:template match="tei:note" priority="1001" mode="M32">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-note-jtei.sch-note-blocks-24-->
   <!--RULE -->
   <xsl:template match="tei:note" priority="1000" mode="M33">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-graphic-jtei.sch-graphic-dimensions-25-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-graphic-jtei.sch-graphic-context-26-->
   <!--RULE -->
   <xsl:template match="tei:graphic" priority="1000" mode="M35">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-author-jtei.sch-author-27-->
   <!--RULE -->
   <xsl:template match="tei:titleStmt/tei:author" priority="1000" mode="M36">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-respStmt-jtei.sch-respSmt-28-->
   <!--RULE -->
   <xsl:template match="tei:respStmt" priority="1000" mode="M37">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-bibl-jtei.sch-bibl-id-29-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-bibl-jtei.sch-bibl-orphan-30-->
   <!--RULE -->
   <xsl:template match="tei:back/tei:div[@type eq 'bibliography']//tei:bibl"
                 priority="1000"
                 mode="M39">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-bibl-jtei.sch-bibl-endpunctuation-31-->
   <!--RULE -->
   <xsl:template match="tei:back/tei:div[@type eq 'bibliography']//tei:bibl"
                 priority="1000"
                 mode="M40">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-bibl-jtei.sch-title-journal-CMOS-32-->
   <!--RULE -->
   <xsl:template match="tei:bibl/tei:title[@level='j']" priority="1000" mode="M41">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-table-jtei.sch-table-33-->
   <!--RULE -->
   <xsl:template match="tei:table" priority="1000" mode="M42">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-titleStmt-jtei.sch-title-34-->
   <!--RULE -->
   <xsl:template match="tei:titleStmt" priority="1000" mode="M43">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-idno-jtei.sch-doi-order-35-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-rendition-jtei.sch-rendition-36-->
   <!--RULE -->
   <xsl:template match="tei:rendition" priority="1000" mode="M45">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-att-jtei.sch-att-37-->
   <!--RULE -->
   <xsl:template match="tei:att" priority="1000" mode="M46">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-tag-jtei.sch-tag-38-->
   <!--RULE -->
   <xsl:template match="tei:tag" priority="1000" mode="M47">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-val-jtei.sch-att-39-->
   <!--RULE -->
   <xsl:template match="tei:val" priority="1000" mode="M48">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-text-jtei.sch-article-keywords-42-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-text-jtei.sch-article-abstract-43-->
   <!--RULE -->
   <xsl:template match="tei:text[not(tei:body/tei:div[@type = ('editorialIntroduction')])]"
                 priority="1000"
                 mode="M50">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-text-jtei.sch-article-back-44-->
   <!--RULE -->
   <xsl:template match="tei:text[not(tei:body/tei:div[@type = ('editorialIntroduction')])]"
                 priority="1000"
                 mode="M51">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-body-jtei.sch-body-45-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-div-jtei.sch-divtypes-front-46-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-div-jtei.sch-divtypes-front2-47-->
   <!--RULE -->
   <xsl:template match="tei:front/tei:div" priority="1000" mode="M54">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-div-jtei.sch-divtypes-back-48-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-div-jtei.sch-divtypes-body-49-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-div-jtei.sch-div-head-50-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-div-abstractModel-structure-div-in-l-or-lg-51-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-div-abstractModel-structure-div-in-ab-or-p-52-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-front-jtei.sch-front-abstract-53-->
   <!--RULE -->
   <xsl:template match="tei:front" priority="1000" mode="M60">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-back-jtei.sch-back-54-->
   <!--RULE -->
   <xsl:template match="tei:back" priority="1000" mode="M61">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-supplied-jtei.sch-supplied-55-->
   <!--RULE -->
   <xsl:template match="tei:supplied" priority="1000" mode="M62">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-straightApos-58-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-LRquotes-59-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-quotationMarks-60-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-doubleHyphens-61-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-rangeHyphen-62-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-ieEg-63-->
   <!--RULE -->
   <xsl:template match="text()[not(ancestor::tei:eg|ancestor::eg:egXML|ancestor::tei:code|ancestor::tei:tag)]"
                 priority="1000"
                 mode="M69">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-nonbreakingspace-64-->
   <!--RULE -->
   <xsl:template match="text()[not(ancestor::tei:eg|ancestor::eg:egXML|ancestor::tei:code|ancestor::tei:tag)]"
                 priority="1000"
                 mode="M70">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-localLinkTarget-65-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-renditionTarget-66-->
   <!--RULE -->
   <xsl:template match="@rendition" priority="1000" mode="M72">
      <xsl:variable name="orphan.pointers"
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-quoteDelim-67-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-crossref-id-68-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-formalCrossref-69-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-crossrefTargetType-70-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-crossrefType-71-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-centuries-72-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-teiVersion-73-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.jtei-url-74-->
   <!--RULE -->
