...
<xsl:stylesheet xmlns:dcr="http://www.isocat.org/ns/dcr"
   ...
   <!--PATTERN schematron-constraint-tei_drama-att.spanning-spanTo-spanTo-points-to-following-8-->
   <!--RULE -->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_drama-l-abstractModel-structure-l-in-l-20-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-lg-abstractModel-structure-lg-in-l-22-->
   <!--RULE -->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_drama-div-abstractModel-structure-div-in-l-or-lg-29-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-div-abstractModel-structure-div-in-ab-or-p-30-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-ab-abstractModel-structure-ab-in-ab-or-p-32-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_drama-ab-abstractModel-structure-ab-in-l-or-lg-33-->
   <!--RULE -->
