...
<xsl:stylesheet xmlns:dcr="http://www.isocat.org/ns/dcr"
   ...
   <!--PATTERN schematron-constraint-tei_ms-att.global.source-source-only_1_ODD_source-5-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-att.measurement-att-measurement-unitRef-6-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-att.typed-subtypeTyped-7-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-att.pointing-targetLang-targetLang-8-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-att.spanning-spanTo-spanTo-points-to-following-9-->
   <!--RULE -->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_ms-att.styleDef-schemeVersion-schemeVersionRequiresScheme-10-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-ptr-ptrAtts-17-->
   <!--RULE -->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_ms-ref-refAtts-18-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-list-gloss-list-must-have-labels-19-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-relatedItem-targetorcontent1-20-->
   <!--RULE -->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_ms-l-abstractModel-structure-l-in-l-21-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-lg-atleast1oflggapl-22-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-lg-abstractModel-structure-lg-in-l-23-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-quotation-quotationContents-24-->
   <!--RULE -->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_ms-citeStructure-delim-citestructure-inner-delim-25-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-citeStructure-match-citestructure-outer-match-26-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-citeStructure-match-citestructure-inner-match-27-->
   <!--RULE -->
   <xsl:template match="tei:citeStructure[parent::tei:citeStructure]"
                 priority="1000"
                 mode="M31">
   ...
   <!--PATTERN schematron-constraint-tei_ms-link-linkTargets3-28-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-ab-abstractModel-structure-ab-in-ab-or-p-29-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-ab-abstractModel-structure-ab-in-l-or-lg-30-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-join-joinTargets3-31-->
   <!--RULE -->
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_ms-standOff-nested_standOff_should_be_typed-32-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-div-abstractModel-structure-div-in-l-or-lg-35-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-div-abstractModel-structure-div-in-ab-or-p-36-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-relation-reforkeyorname-37-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-relation-activemutual-38-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-relation-activepassive-39-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-addSpan-addSpan-requires-spanTo-41-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-damageSpan-damageSpan-requires-spanTo-43-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-delSpan-delSpan-requires-spanTo-45-->
   <!--RULE -->
