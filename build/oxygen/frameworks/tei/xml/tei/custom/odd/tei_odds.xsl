...
<xsl:stylesheet xmlns:dcr="http://www.isocat.org/ns/dcr"
   ...
   <!--PATTERN schematron-constraint-tei_odds-att.global.source-source-only_1_ODD_source-5-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-att.measurement-att-measurement-unitRef-6-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-att.typed-subtypeTyped-7-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-att.pointing-targetLang-targetLang-8-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-att.spanning-spanTo-spanTo-points-to-following-9-->
   <!--RULE -->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_odds-att.styleDef-schemeVersion-schemeVersionRequiresScheme-10-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-ptr-ptrAtts-17-->
   <!--RULE -->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_odds-ref-refAtts-18-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-list-gloss-list-must-have-labels-19-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-relatedItem-targetorcontent1-20-->
   <!--RULE -->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_odds-l-abstractModel-structure-l-in-l-21-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-lg-atleast1oflggapl-22-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-lg-abstractModel-structure-lg-in-l-23-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-quotation-quotationContents-24-->
   <!--RULE -->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_odds-citeStructure-delim-citestructure-inner-delim-25-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-citeStructure-match-citestructure-outer-match-26-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-citeStructure-match-citestructure-inner-match-27-->
   <!--RULE -->
   <xsl:template match="tei:citeStructure[parent::tei:citeStructure]"
                 priority="1000"
                 mode="M35">
   ...
   <!--PATTERN schematron-constraint-tei_odds-div-abstractModel-structure-div-in-l-or-lg-30-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-div-abstractModel-structure-div-in-ab-or-p-31-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-att.repeatable-MINandMAXoccurs-32-->
   <!--RULE -->
   <xsl:template match="*[ @minOccurs  and  @maxOccurs ]" priority="1001" mode="M38">
   ...
   <!--PATTERN schematron-constraint-tei_odds-att.identified-spec-in-module-33-->
   <!--RULE -->
...
should correspond to an existing module, via a moduleSpec or
   ...
   <!--PATTERN schematron-constraint-tei_odds-att.deprecated-validUntil-deprecation-two-month-warning-34-->
   <!--RULE -->
   <xsl:template match="tei:*[@validUntil]" priority="1000" mode="M40">
   ...
   <!--PATTERN schematron-constraint-tei_odds-att.deprecated-validUntil-deprecation-should-be-explained-35-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-moduleRef-modref-36-->
   <!--RULE -->
...
Child elements of <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_odds-moduleRef-prefix-not-same-prefix-37-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-moduleRef-prefix-not-except-and-include-38-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-elementSpec-child-constraint-based-on-mode-39-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-listRef-TagDocsNestinglistRef-40-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-listRef-TagDocslistRefChildren-41-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-altIdent-deprecate_altIdent_in_non-ODD_places-42-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-altIdent-altIdent_usually_an_NCName-43-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-model-no_dup_default_models-44-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-model-no_dup_models-45-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-modelSequence-no_outputs_nor_predicates_4_my_kids-46-->
   <!--RULE -->
   <xsl:template match="tei:modelSequence" priority="1000" mode="M52">
   ...
   <!--PATTERN schematron-constraint-tei_odds-sequence-sequencechilden-47-->
   <!--RULE -->
   <xsl:template match="tei:sequence" priority="1000" mode="M53">
   ...
   <!--PATTERN schematron-constraint-tei_odds-alternate-alternatechilden-48-->
   <!--RULE -->
   <xsl:template match="tei:alternate" priority="1000" mode="M54">
   ...
   <!--PATTERN schematron-constraint-tei_odds-constraintSpec-empty-based-on-mode-49-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-constraintSpec-sch_no_more-50-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-constraintSpec-isosch-51-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-constraintSpec-needrules-52-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-constraintSpec-unique-constraintSpec-ident-53-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-attDef-attDefContents-54-->
   <!--RULE -->
   <xsl:template match="tei:attDef" priority="1000" mode="M60">
   ...
   <!--PATTERN schematron-constraint-tei_odds-attDef-noDefault4Required-55-->
   <!--RULE -->
   <xsl:template match="tei:attDef[@usage eq 'req']" priority="1000" mode="M61">
   ...
   <!--PATTERN schematron-constraint-tei_odds-attDef-defaultIsInClosedList-twoOrMore-56-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-attDef-defaultIsInClosedList-one-57-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-dataRef-restrictDataFacet-58-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-dataRef-restrictAttRestriction-59-->
   <!--RULE -->
   <xsl:template match="tei:dataRef[tei:dataFacet]" priority="1000" mode="M65">
   ...
   <!--PATTERN schematron-constraint-tei_odds-dataRef-restrictAttResctrictionName-60-->
   <!--RULE -->
   <xsl:template match="tei:dataRef" priority="1000" mode="M66">
   ...
   <!--PATTERN schematron-constraint-tei_odds-link-linkTargets3-61-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-ab-abstractModel-structure-ab-in-ab-or-p-62-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-ab-abstractModel-structure-ab-in-l-or-lg-63-->
   <!--RULE -->
   <xsl:template match="tei:ab" priority="1000" mode="M69">
   ...
   <!--PATTERN schematron-constraint-tei_odds-join-joinTargets3-64-->
   <!--RULE -->
   <xsl:template match="tei:join" priority="1000" mode="M70">
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_odds-standOff-nested_standOff_should_be_typed-65-->
   <!--RULE -->
   <xsl:template match="tei:standOff" priority="1000" mode="M71">
