...
<xsl:stylesheet xmlns:iso="http://purl.oclc.org/dsdl/schematron"
   ...
   <!--PATTERN schematron-constraint-tei_minimal-att.global.source-source-only_1_ODD_source-5-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-p-abstractModel-structure-p-in-ab-or-p-7-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-p-abstractModel-structure-p-in-l-or-lg-8-->
   <!--RULE -->
