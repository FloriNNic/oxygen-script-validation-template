...
<xsl:stylesheet xmlns:esp-d2e29549="http://www.tei-c.org/ns/tite/1.0"
                xmlns:esp-d2e29563="http://www.tei-c.org/ns/tite/1.0"
                xmlns:esp-d2e29577="http://www.tei-c.org/ns/tite/1.0"
                xmlns:esp-d2e29591="http://www.tei-c.org/ns/tite/1.0"
                xmlns:esp-d2e29605="http://www.tei-c.org/ns/tite/1.0"
                xmlns:esp-d2e29619="http://www.tei-c.org/ns/tite/1.0"
                xmlns:esp-d2e29634="http://www.tei-c.org/ns/tite/1.0"
                xmlns:esp-d2e29653="http://www.tei-c.org/ns/tite/1.0"
                xmlns:esp-d2e29663="http://www.tei-c.org/ns/tite/1.0"
                xmlns:esp-d2e29673="http://www.tei-c.org/ns/tite/1.0"
   ...
   <!--PATTERN schematron-constraint-tei_tite-att.global.source-source-only_1_ODD_source-5-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_tite-att.typed-subtypeTyped-6-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_tite-p-abstractModel-structure-p-in-ab-or-p-8-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_tite-p-abstractModel-structure-p-in-l-or-lg-9-->
   <!--RULE -->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_tite-l-abstractModel-structure-l-in-l-14-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_tite-lg-abstractModel-structure-lg-in-l-16-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_tite-ab-abstractModel-structure-ab-in-ab-or-p-17-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_tite-ab-abstractModel-structure-ab-in-l-or-lg-18-->
   <!--RULE -->
